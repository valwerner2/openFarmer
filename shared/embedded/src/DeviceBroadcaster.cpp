...
namespace IOT
{
    ...
    void DeviceBroadcaster::loadName()
    {
        ...
        name_ = preferences_.getString("name", purpose_); // fallback: empty
        preferences_.end();
    }
    ...
    void DeviceBroadcaster::init(AsyncWebServer& server)
    {
    ...
    void DeviceBroadcaster::sendBroadcast(const JsonDocument& extraInfo)
    {
        //wifi not connected
    ...
    void DeviceBroadcaster::sendBroadcast(const unsigned long msInterval, const JsonDocument& extraInfo)
    {
